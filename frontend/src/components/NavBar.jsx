...
// const NavBar = () => {
//     let Links =[
//         {name: 'Account', link:'/acc'},
//         {name: 'Sign out', link:'/'}
//     ]

//     return (
//         <nav
//   class="block w-full max-w-screen-xl px-4 py-3 mx-auto text-black shadow-md rounded-xl bg-gradient-to-tr from-blue-gray-900 to-blue-gray-800">
//   <div class="flex flex-wrap items-center justify-between text-black gap-y-4">
//     <a href="#"
...
//       <button
//         class="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-black transition-all hover:bg-white/10 active:bg-white/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
//         type="button">
...
const Navbar = () => {
    return (
        <div className="bg-gray-800 text-white flex justify-between items-center p-4">
            <div>
                <img src="https://via.placeholder.com/150" alt="Placeholder" className="h-10 w-10" />
            </div>
